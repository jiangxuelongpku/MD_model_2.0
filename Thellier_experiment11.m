% Thellier experiment 11
% change HK to 5e-3，time for stay on earth to 1B year.
p = 1/50*ones(1,50);
Tstart = 560;
Tend = 20;
Blab = 5e-5;
...
for i = 1:50
    ...
    result = results{1,i};
    outputname = ['constant-coercivity/Coe/10step_seq/50uTnrm50uTlab1e9yr/' filename];
